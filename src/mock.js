...
//模拟Java服务器端产生验证码方法：
//mock()方法参数：1 请求路径，参数2请求方式，参数3产生验证码代码
//服务器端产生的验证码，会存储到Redis缓存数据库中，使用key-value存储。所以这边模拟也需要返回完成数据
Mock.mock('/api/captcha', 'get', () => {
  {
    Result.resultdata = {
      key: Random.string(32),//模拟服务器端产生32位随机码
      captchaImg: Random.dataImage('100x40', '5wn3Q')//生产验证码
    }
  }
  return Result
})
...
Mock.mock('/api/login', 'post', () => {
  //在这里，是没有办法验证用户名和密码是否正确，因为只是模拟登录结果(假设登录成功)。
  //
  console.log('mock模拟登陆方法执行...')
  Result.message = '登录操作失败'
  Result.code = 20000
  return Result
...
Mock.mock('/api/userinfo', 'get', () => {
  ...
  Result.resultdata = {
    id: '1',
    username: 'admin',
    avatar: 'https://tupian.qqw21.com/article/UploadPic/2020-4/202041822464714636.jpg',
  }
  return Result
})
    ...
    },
    {
      ...
      children: [
...

        {
          ...
          path: '/Plating',
          name: 'cinema:Plating:list',
          perms: null,
          component: 'cinema/Plating',
          children: [],
        },
...
Mock.mock(RegExp('/movie/list*'), 'get', () => {
  ...
  Result.resultdata = {
    records: [
      {
        id: 1,
        data1: '2022-12-11T09:04:12',
        statu: 1,
        moviename: '功夫熊猫',
        avatar:
          'https://i01piccdn.sogoucdn.com/ec5e21ae7bed3526',
        area: '中国',
        time: 90,
        start: 3.6,
        type:'动画片',
      ...
      {
        id: 2,
        data1: '2022-12-09T10:06:40',
        statu: 1,
        moviename: '警察故事',
        avatar:
          'https://img1.baidu.com/it/u=957710017,1662020568&fm=253&app=138&size=w931&n=0&f=JPEG&fmt=auto?sec=1670691600&t=86dec01af9122282e66e74b1fbb4bb6f',
        area: '中国',
        time: 120,
        start: 3.5,
        type:'动作片'
      },
      {
        ...
        moviename: '喜羊羊',
        avatar:
          'https://i04piccdn.sogoucdn.com/0e5fbbb51f9b51f6',
        area: '中国',
        time: 130,
        start: 0,
        type:'动画片'
...
//轮播图数据
Mock.mock(RegExp('/carouse/list*'), 'get', () => {
  Result.code = 20000
  Result.message = '请求用户数据成功'
  Result.resultdata = {
    records: [
      {
        id: 1,
        data1: '2022-12-11T09:04:12',
        data2: '2023-11-12T12:21:45',
        statu: 1,
        moviename: '大圣归来',
        avatar:
          'https://i03piccdn.sogoucdn.com/a573e090f48d0206',
        area: '中国',
      },
      {
        id: 2,
        data1: '2022-12-09T10:06:40',
        data2: '2023-03-11T06:12:35',
        statu: 1,
        moviename: '勇敢的心',
        avatar:
          'https://i02piccdn.sogoucdn.com/3cc089010d3a77ef',
      },
      {
        id: 3,
        data1: '2022-12-09T10:06:40',
        data2: '2023-10-28T05:25:44',
        statu: 1,
        moviename: '奥特曼',
        avatar:
          'https://i01piccdn.sogoucdn.com/daf61307459e7f73',
      },
    ],
    total: 3,
    size: 10,
  ...
  Result.resultData = {
      records: [{
      ...
      },
          {
              id:22123,
              username:'荒',
              avatar:'https://tupian.qqw21.com/article/UploadPic/2020-3/20203112226216037.jpg',
              email:'123@qq.com',
              sex:1,
              created:'2022-12-12 00:00:00',
              statu:1,
...
//评论数据
Mock.mock(RegExp('/comment/list*'), 'get', () => {
  Result.code = 20000
  Result.message = '请求用户数据成功'
  Result.resultData = {
      records: [            {
...
//订单数据
Mock.mock(RegExp('/order/list*'), 'get', () => {
  Result.code = 20000
  Result.message = '请求用户数据成功'
  Result.resultData = {
      records: [{
